...
quadratic forms in the package [`qfratio`](https://github.com/watanabe-j/qfratio).
...
by @HansenHoule2008.
Existing packages like `evolvability` and `evolqg` have these functionalities,
but this package's implementation is more general (Monte Carlo versions
accommodate arbitrary mean and covariance) and faster, as of developing this.
